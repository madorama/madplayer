...
import { ApiRequest, ApiResponse, ApiChannel } from "./api"

export class IpcMain {
  public static handle<T extends ApiChannel>(channel: T, listener: (event: Electron.IpcMainInvokeEvent, req: ApiRequest[T]) => ApiResponse[T]) {
